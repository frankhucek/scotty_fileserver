...
Elm.Testpage = Elm.Testpage || {};
Elm.Testpage.make = function (_elm) {
   "use strict";
   _elm.Testpage = _elm.Testpage || {};
   if (_elm.Testpage.values)
   return _elm.Testpage.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
